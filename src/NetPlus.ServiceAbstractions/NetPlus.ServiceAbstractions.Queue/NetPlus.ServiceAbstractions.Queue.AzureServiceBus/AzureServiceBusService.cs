...
using NetPlus.ServiceAbstractions.Queue.AzureServiceBus.Connection;
using NetPlus.ServiceAbstractions.Queue.AzureServiceBus.Interfaces;
using Newtonsoft.Json;

namespace NetPlus.ServiceAbstractions.Queue.AzureServiceBus
{
    /// <summary>
