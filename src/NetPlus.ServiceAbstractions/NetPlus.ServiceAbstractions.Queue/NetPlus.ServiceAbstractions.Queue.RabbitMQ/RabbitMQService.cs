using System.Text;
using NetPlus.ServiceAbstractions.Queue.RabbitMQ.Connection;
using NetPlus.ServiceAbstractions.Queue.RabbitMQ.Interfaces;
using Newtonsoft.Json;
using RabbitMQ.Client;
using RabbitMQ.Client.Events;

namespace NetPlus.ServiceAbstractions.Queue.RabbitMQ;
